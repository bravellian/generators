...
public class DtoEntitySourceGenerator
{
    ...
    /// </summary>
    public static DtoEntityGenerator.GeneratorParams? GetParamsFromXml(XElement xml, IPwLogger? logger)
    {
    ...
    private static List<DtoEntityGenerator.PropertyDescriptor> ParseProperties(IEnumerable<XElement> propertyElements, IPwLogger? logger)
    {
        var properties = new List<DtoEntityGenerator.PropertyDescriptor>();
    ...
    private static List<DtoEntityGenerator.GeneratorParams> ParseNestedEntities(IEnumerable<XElement> nestedElements, string parentNamespace, string parentName, IPwLogger? logger)
    {
