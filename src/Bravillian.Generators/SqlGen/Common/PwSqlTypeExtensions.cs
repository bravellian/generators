...
namespace Bravillian.Generators.SqlGen.Common;

/// <summary>
/// Extension methods for PwSqlType.
/// </summary>
public static class PwSqlTypeExtensions
{
    /// <summary>
    ...
    public static PwSqlType SafeParseSqlType(this string sqlType, IPwLogger? logger = null)
    {
        try
        {
            return PwSqlType.Parse(sqlType);
