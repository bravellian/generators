...
using Bravillian.Generators.SqlGen.Pipeline._1_Ingestion.Model;
using Bravillian.Generators.SqlGen.Common.Configuration;
using Microsoft.SqlServer.TransactSql.ScriptDom;
using Bravillian.Generators.SqlGen.Pipeline._2_SchemaRefinement.Model;
using Bravillian.Generators.SqlGen.Common;
using Bravillian.Generators.SqlGen.Pipeline._3_CSharpTransformation.Models;

namespace Bravillian.Generators.SqlGen.Pipeline._2_SchemaRefinement
{
    /// <summary>
    ...
    public class SchemaRefiner : ISchemaRefiner
    {
        ...
        public SchemaRefiner(IPwLogger logger, SqlConfiguration? configuration, UsedConfigurationTracker? usageTracker = null)
        {
            _logger = logger;
