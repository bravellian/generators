...
internal interface ISqlColumnTypeResolver
{
    ...
    string GetFunctionReturnType(string functionName, FunctionCall functionCall, Dictionary<string, PwTableDefinition> tableDefinitions, Dictionary<string, string> tableAliases, IPwLogger? logger = null);
