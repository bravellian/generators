...
namespace Bravillian.Generators.SqlGen.Pipeline._3_CSharpTransformation
{
    /// <summary>
    ...
    public class CSharpModelTransformer : ICSharpModelTransformer
    {
        ...
        public CSharpModelTransformer(IPwLogger logger, SqlConfiguration configuration, UsedConfigurationTracker? usageTracker)
        {
            _logger = logger;
