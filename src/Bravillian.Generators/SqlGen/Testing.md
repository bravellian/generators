...
The test project (`Bravillian.Generators.SqlGen.Tests`) is structured to mirror the main project's organization, with the following test categories:
...
```bash
dotnet test Bravillian.Generators.SqlGen.Tests
```
