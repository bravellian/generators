...
1. In Visual Studio: Go to Dependencies > Analyzers > Bravillian.Generators > Bravillian.Generators.SqlGen.SqlEntitySourceGenerator
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <PackageReference Include="Bravillian.Generators" Version="1.0.0" PrivateAssets="all" />
  </ItemGroup>
