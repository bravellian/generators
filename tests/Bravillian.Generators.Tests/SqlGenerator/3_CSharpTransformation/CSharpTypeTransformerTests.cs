...
using System.Linq;
// using Bravillian.Generators.SqlGen.Common.TypeMapping; // This namespace doesn't exist

namespace Bravillian.Generators.Tests.SqlGenerator._3_CSharpTransformation
{
