...
namespace Bravellian.Generators.Tests.SqlGenerator.2_SchemaRefinement
{
    ...
    public class SchemaRefinerTests
    {
        ...
        public void Refine_WithBasicTable_ShouldCreateModel()
        {
            ...
            Assert.Contains(table.Columns, c => string.Equals(c.Name, "Id", StringComparison.Ordinal) && string.Equals(c.DatabaseType.Value, "int", StringComparison.OrdinalIgnoreCase) && !c.IsNullable);
            Assert.Contains(table.Columns, c => string.Equals(c.Name, "Name", StringComparison.Ordinal) && string.Equals(c.DatabaseType.Value, "nvarchar", StringComparison.OrdinalIgnoreCase) && c.IsNullable);
        }
...
(StringComparer.Ordinal)
            ...
            Assert.Contains(view.Columns, c => string.Equals(c.Name, "UserId", StringComparison.Ordinal) && string.Equals(c.DatabaseType.Value, "int", StringComparison.OrdinalIgnoreCase) && !c.IsNullable);
            Assert.Contains(view.Columns, c => string.Equals(c.Name, "UserName", StringComparison.Ordinal) && string.Equals(c.DatabaseType.Value, "nvarchar", StringComparison.OrdinalIgnoreCase) && c.IsNullable);
        }
        ...
        public void Refine_ViewWithDerivedColumns_ShouldInferTypesFromBaseTable()
        {
            ...
            var idCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "Id", StringComparison.Ordinal));
            ...
            var nameCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "Name", StringComparison.Ordinal));
        ...
        public void Refine_ViewWithAliasedTableAndColumns_ShouldInferTypesCorrectly()
        {
            ...
            var skuCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "Sku", StringComparison.Ordinal));
            ...
            var priceCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "UnitPrice", StringComparison.Ordinal));
        ...
        public void Refine_ViewWithIndeterminateColumn_ShouldMarkColumn()
        {
            ...
            var sourceCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "Source", StringComparison.Ordinal));
            Assert.NotNull(sourceCol);
            Assert.True(sourceCol.IsIndeterminate);
            Assert.Equal(PwSqlType.Unknown, sourceCol.DatabaseType);

            var dateCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "CreatedDate", StringComparison.Ordinal));
        ...
        public void Refine_ViewWithJoin_ShouldInferTypesFromCorrectTables()
        {
            ...
            var orderIdCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "OrderId", StringComparison.Ordinal));
            ...
            var nameCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "CustomerName", StringComparison.Ordinal));
            Assert.NotNull(nameCol);
            Assert.Equal("NVARCHAR", nameCol.DatabaseType.Value);
            Assert.True(nameCol.IsNullable);
            Assert.False(nameCol.IsIndeterminate);
        ...
        public void Refine_WithForeignKey_ShouldBeAddedToTable()
        {
            ...
            // Assert
            var productsTable = refinedSchema.Objects.First(o => string.Equals(o.Name, "Products", StringComparison.Ordinal));
        ...
        public void Refine_ViewWithSubquery_ShouldInferTypesFromSubquery()
        {
            ...
            var categoryCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "CategoryName", StringComparison.Ordinal));
        ...
        public void Refine_ViewWithAggregateFunction_ShouldInferAggregateType()
        {
            ...
            var totalCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "TotalAmount", StringComparison.Ordinal));
        ...
        public void Refine_ViewWithIsnullFunction_ShouldInferTypeAndBeNonNullable()
        {
            ...
            var nameCol = view.Columns.FirstOrDefault(c => string.Equals(c.Name, "ItemName", StringComparison.Ordinal));
            Assert.NotNull(nameCol);
            Assert.Equal("NVARCHAR", nameCol.DatabaseType.Value);
    ...
    public class TestLogger : IBvLogger
    {
        ...
        {
            this.Errors.Add($"{error}: {exception.Message}");
        }
